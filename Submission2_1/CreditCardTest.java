...
public class CreditCardTest {
	...
	public void testSetAndGetName() throws Exception {
		...
		Method setAccountHolderMethod = Class.forName("CreditCard").getMethod("setCardHolder", "".getClass());
		Method getAccountHolderMethod = Class.forName("CreditCard").getMethod("getCardHolder");
	...
	public void testDifferentAccountNumbers() throws Exception {
		for (int i = 0; i < 100; i++) {
			CreditCard cc2 = new CreditCard();
			Method getAccountNumberMethod = Class.forName("CreditCard").getMethod("getCardNumber");
	...
	public void testCharge() throws Exception {
		double amount = 1000;
		Method chargeMethod = Class.forName("CreditCard").getMethod("charge", double.class);
	...
	public void testInitialLimit() throws Exception {
		Method getCreditLimitMethod = Class.forName("CreditCard").getMethod("getCreditLimit");
	...
	public void testGetAndSetLimit() throws Exception {
		double amount = 400;
		Method setCreditLimitMethod = Class.forName("CreditCard").getMethod("setCreditLimit", double.class);
		Method getCreditLimitMethod = Class.forName("CreditCard").getMethod("getCreditLimit");
	...
	public void testChargePayCharge() throws Exception {
		...
		Method makePaymentMethod = Class.forName("CreditCard").getMethod("makePayment", double.class);
